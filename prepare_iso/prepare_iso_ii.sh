...
# some process notes here: https://gist.github.com/4542016.
#
# The sample minstallconfig.xml, use of OSInstall.collection,
# and README documentation provided with Greg Neagle's createOSXInstallPkg tool
# also proved very helpful. (http://code.google.com/p/munki/wiki/InstallingOSX)
#
...
# Flags
export DISABLE_REMOTE_MANAGEMENT=0
export DISABLE_SCREEN_SHARING=0
export DISABLE_SIP=0
